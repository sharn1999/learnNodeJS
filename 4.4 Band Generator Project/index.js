...
app.post("/submit", (req, res) => {
  const random = {
    random1: Math.floor(Math.random() * adj.length),
    random2: Math.floor(Math.random()* noun.length)
  }
  const bandName = adj[random.random1] + " " + noun[random.random2];
  const date = new Date();
  console.log(random.random1)
  res.render("index.ejs", { year: date.getFullYear(), band: bandName });
